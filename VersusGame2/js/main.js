...
class SceneManager {
    ...
    switchTo(name) {
        ...
        // Clear virtual keys when switching scenes to avoid stuck keys
        this.game.inputHandler.clearVirtualKeys();
    }
...
class Game {
    ...
    setupEvents() {
        ...
        // Setup touch controls after DOM ready
    ...
    setupTouchControls() {
        ...
        if (joystickArea && joystickBase && joystickStick) {
            this.inputHandler.setupJoystick(joystickArea, joystickBase, joystickStick);
        }

        this.inputHandler.setupTouchButtons();
    }
